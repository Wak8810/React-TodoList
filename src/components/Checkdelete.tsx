...
type CheckdeleteProps = {
    ...
    onDelete: (index: number) => void;  // 削除する関数
        ...
        <>
            <div className={TodoCard + `${getPriorityColor(todo.priority)}`}>
                ...
                <div className="flex flex-row justify-between w-[60%] mx-auto mt-4">
                    <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={ () => onDelete(todo.index) }>削除</button>
